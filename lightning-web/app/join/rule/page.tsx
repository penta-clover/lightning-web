          ...
          <div className="flex flex-col space-y-[16px]">
            ...
            >
              <input
                ...
                className="w-[24px] min-w-[24px] h-[24px] m-[12px] border-0 bg-bggray rounded-[4px] bg-[url('/icon/gray_checkbox.svg')] checked:bg-[url('/icon/black_checkbox.svg')] checked:border-blue-500 appearance-none transition-all"
              />
